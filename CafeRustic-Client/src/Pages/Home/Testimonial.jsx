  ...
  return (
    <>
      <SectionTitle
        ...
        subText={"Our Customers"}
      ></SectionTitle>

      <div className="flex justify-center flex-col items-center gap-4">
        <Rating style={{ maxWidth: 200 }} value={5} readOnly />
        <svg
        ...
        <p className="max-w-4xl text-center font-Inter text-gray-600 text-xs md:text-base">
          Stumbled upon Cafe Rustic during my visit to Italy, and what a hidden
          gem it turned out to be! The Wood-Fired Pizzas were a revelation,
          perfectly crispy and topped with fresh ingredients. The cozy
          atmosphere and friendly staff made me want to linger for hours. A
          must-visit for anyone seeking an authentic taste of Italian cuisine.
        </p>
        <h1 className="font-Cinzel font-bold text-primary text-center text-sm md:text-2xl">{`"A Hidden Gem in the Heart of Italy"`}</h1>
      </div>
    </>
  );
};
